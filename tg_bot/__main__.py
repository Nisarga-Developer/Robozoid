...
PM_START_TEXT = """
**Hello {}, My Name is {}!** 
I am an **AWESOME**  group management bot.
...
TECHNO_IMG = "https://i.ibb.co/mzBLSnH/Untitled-design.png"
IMPORTED = {}
MIGRATEABLE = []
HELPABLE = {}
STATS = []
            ...
            update.effective_message.reply_photo(
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="Help",
                                                                       callback_data="help_back".format(bot.username)),
                                                                                   InlineKeyboardButton(text="My Developer",
                                                                       url="t.me/Nisarga_Adhikary")],
                                                                                   [InlineKeyboardButton(text="Add Me To Your Group",
                                                                       url="t.me/{}?startgroup=true".format(bot.username)),
                                                                                   InlineKeyboardButton(text="Source Code",
                                                                       url="https://github.com/Nisarga-Developer/Robozoid")
                                                                                 ]]))
